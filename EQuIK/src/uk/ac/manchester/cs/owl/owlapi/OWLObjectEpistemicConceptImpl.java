 ...
 */
public class OWLObjectEpistemicConceptImpl extends OWLAnonymousClassExpressionImpl implements OWLObjectEpistemicConcept {

    private OWLClassExpression operand;


    public OWLObjectEpistemicConceptImpl(OWLDataFactory dataFactory, OWLClassExpression operand) {
        super(dataFactory);
    ...
    public boolean equals(Object obj) {
        if (super.equals(obj)) {
            ...
            return ((OWLObjectEpistemicConcept) obj).getOperand().equals(operand);
        }
        return false;
    }
