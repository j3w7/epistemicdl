...
//    }
	...
	public void visit(OWLObjectEpistemicConcept ce) {
		System.out.println("Epistemic UnImplemented Method in "+this.getClass().getCanonicalName());
		
	}


	@Override
	public void visit(OWLObjectEpistemicRole expression) {
		 expression.getEpistemicRole().accept(this);
