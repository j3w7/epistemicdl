...
//    public OWLObjectEpistemicOf getOWLObjectEpistemicOf(OWLClassExpression operand){
//		return new OWLObjectEpistemicOfImpl(this, operand);
//    	
//    }
    @Override
	public OWLObjectEpistemicConcept getOWLObjectEpistemicConcept(OWLClassExpression operand) {
		return new OWLObjectEpistemicConceptImpl(this,operand);
	}
	...
	@Override
	public OWLObjectEpistemicRole getOWLObjectEpistemicRole(OWLObjectPropertyExpression property) {
		  return new OWLObjectEpistemicRoleImpl(this, property);
	}
