...
public class RDFParser extends DefaultHandler implements RDFConstants {
    ...
    /**
     * Current equik.parser's state.
     */
    protected State m_state;

    /**
     * Stack of equik.parser states.
     */
...
//        return nodeID;
    ...
    /**
     * Tests whether supplied IRI was generated by this equik.parser in order to label an anonymous node.
     * @param uri the IRI
     * @return <code>true</code> if the IRI was generated by this equik.parser to label an anonymous node
     */
...
//        throw new RuntimeException("DISABLED");
    ...
    /**
     * Base class for all equik.parser states.
     */
