...
public interface OWLDataFactory extends SWRLDataFactory {
    ...
    OWLObjectEpistemicRole getOWLObjectEpistemicRole(OWLObjectPropertyExpression property);
    ...
    OWLObjectEpistemicConcept getOWLObjectEpistemicConcept(OWLClassExpression operand);
