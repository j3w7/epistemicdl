...
//		EC6
		...
		OWLObjectPropertyExpression kAdjRegion = factory.getOWLObjectEpistemicRole(adjRegion);
		...
		OWLObjectPropertyExpression kProducesWine = factory.getOWLObjectEpistemicRole(producesWine);
