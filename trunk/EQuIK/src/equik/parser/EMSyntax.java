...
public enum EMSyntax {
    ...
    KC("KnownConcept", false, false, false, false, true),

    KR("KnownRole", false, false, true, false, false),
    ...
    private EMSyntax(String rendering, boolean frameKeyword, boolean sectionKeyword, boolean axiomKeyword, boolean classExpressionQuantifierKeyword, boolean classExpressionConnectiveKeyword) {
